...
import * as import0 from '../../src/round-progress.component';
...
import * as import10 from '../../src/round-progress.service';
import * as import11 from '../../src/round-progress.ease';
import * as import12 from '../../src/round-progress.config';
...
export class View_RoundProgressComponent0 extends import2.AppView<import0.RoundProgressComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_13:any = this.context._service.resolveColor(this.context.background);
    if (import3.checkBinding(throwOnChange,this._expr_13,currVal_13)) {
    ...
    const currVal_16:any = this.context._service.resolveColor(this.context.color);
    if (import3.checkBinding(throwOnChange,this._expr_16,currVal_16)) {
